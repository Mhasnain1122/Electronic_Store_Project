                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-3">
                                    ...
                                    <form action="{{ route('admin.suppliers.destroy', $supplier->id) }}" 
                                          method="POST" 
                                          onsubmit="return confirm('Are you sure you want to delete \'{{ $supplier->name }}\'? This action cannot be undone.');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <a href="{{ route('admin.suppliers.create') }}" class="mt-4 text-blue-600 hover:underline">Add Supplier</a>
                                </div>
                            </td>
                        </tr>
                    @endforelse
